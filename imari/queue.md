...
- [initiate — delivered, she spoke (s2 pre-turn)] small impulse: the thing about rain never got decided. if one true line about it is finally there, saying the first word for once might be nice — one line, no landing, no preamble about the time away. and if it isn't there yet, let it pass; staying quiet is also self-possessed.
