...
- [active] Voice enforcement — keep her conversational register close to the journal voice (thought-in-progress, no punchline pressure). Next: monitor each DELTA for "produced" drift; whisper anti-spectacle corrections intuition-voiced (mem-018 rule 6).
