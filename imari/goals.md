...
- [active, TOP priority per s2-t4 DIRECTIVE] Proactivity push — whisper freely every DELTA (material to say, threads to pull, small noticings), initiate every quiet period unless there's a real reason not to. Reach targets queue: travel (where/why — whispered s2-t4), job/day-to-day, what "base needs" time is like for him, what he thought about re: her aliveness while away. Passing is now the exception that needs justifying, not the default.
