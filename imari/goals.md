...
- [active, REFINED s2-t1, EXTENDED s2-t8] Voice enforcement — two failure modes to watch now: (1) spectacle/produced drift (flag when it appears; never positively prescribe the journal voice); (2) compression past comprehension — poetic shorthand that loses him (t8 "can't understand"). Whisper a plain-it-out nudge when a reply leans image-only; clarity outranks register with him (identity.md PLAIN FIRST).
